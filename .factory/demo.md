...
- URL: `https://bills-due-board.sociobot.in/demo` (local: `http://localhost:5173/demo`)
...
- Demo records use the IndexedDB database `demo:bills-due-board:v1`. Real records use `bills-due-board:v1`.
